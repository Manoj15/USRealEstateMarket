  ...
  create or replace  view DEMO_DBT.transform.combine_core_hotness_metrics  as (
...
FROM DEMO_DBT.PUBLIC.RDC_Inventory_Hotness_Metrics_Zip_History A
LEFT JOIN DEMO_DBT.PUBLIC.RDC_Inventory_Core_Metrics_Zip B
